...
const SKILL_GROUPS: SkillGroup[] = [
  ...
  {
    label: 'Real-Time & Runtime Architecture',
    accentColor: 'var(--color-auto)',
    items: [
      'Runtime architecture & OS internals',
      'Deterministic multicore scheduling & data exchange',
      'Synchronized schedule tables (µs precision)',
      'Time synchronization (CanTsyn/StbM · PTP)',
      'Spinlocks · X-signals · cross-core IPC · atomics',
      'Bare-metal RTOS · custom schedulers',
      'ISR-driven design · DMA / DAC / ADC',
      'Embedded C (expert, 9+ years) · Assembly (ARM / TriCore)',
      'ARM Cortex-M/R/A families',
      'Lauterbach TRACE32 · GLIWA · oscilloscope · logic analyzer',
      'SPI / I2C / UART / CAN / CAN-FD · MIPI CSI-2 / GMSL3 / DSI3',
    ],
  },
  {
